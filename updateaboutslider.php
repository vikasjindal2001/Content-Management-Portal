...
<body>
    ...
    include('config.php');
    $execute = "SELECT * FROM `aboutslider` WHERE id=".$id;
	...
	<form method="post"  enctype="multipart/form-data">
		<table class="table table-responsive table-bordered table-striped" >
			...
			<tr>
			<td colspan=2 ><input style="margin-left:40%;" type="submit" class="btn-primary" name="sub" value="UPDATE">&nbsp &nbsp &nbsp &nbsp<a href="adminaboutslider.php"><input  type="button" class="btn-danger" value="EXIT"></a></td>
			</tr>
...
if(isset($_POST['sub']))
{
	...
	if(move_uploaded_file($filetemp,$des))
	{
       ...
       $select = "update aboutslider set name='$username' , image='$filename' , description='$description' where id=".$id;
