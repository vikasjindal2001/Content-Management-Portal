...
<body>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <?php echo "<a href='deletebanner.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='DELETE'></a><br><br> <a href='updatebanner.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='UPDATE'></a>";?>
            </td>
        </tr>
    <?php
     }
    ...
    <tr>
    <td colspan=6>
    <a style="margin-left:50%; padding:10px;" href="addbanner.php"><input class="btn btn-primary" type="button" name="Addbanner" value="ADD BANNER"></a>
    </td> 
    </tr>
     </tbody>         
    </table>
