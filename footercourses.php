...
<body>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <?php echo "<a href='deletefootercourse.php?ID=$column[0]'><input type='button' class='btn btn-danger' name='btn' value='DELETE'></a>";?>
            </td>
        </tr>
    <?php
     }
    ...
    <tr>
    <td colspan=6>
    <a style="margin-left:50%; padding:10px;" href="addfootercourses.php"><input class="btn btn-primary" type="button" name="AddFooter" value="ADD Footer Course"></a>
    </td> 
    </tr>
     </tbody>         
    </table>
