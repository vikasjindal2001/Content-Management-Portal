...
<body>
    ...
    <br>
    <br>
    <h1><b>FEATURED COURSES ARE</b></h1>
    <div class="container">
    ...
    <thead style="background-color:black;">
        <tr>
            ...
            <th>
                <span  style="color:white;">COURSE NAME</span>
            </th>
            <th>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <?php echo "<a href='deletefeaturecourse.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='DELETE'></a><br><br><a href='updatefeaturecourse.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='UPDATE'></a>";?>
            </td>
        </tr>
    <?php
     }
    ...
    <tr>
    <td colspan=6>
    <a style="margin-left:50%; padding:10px;" href="addfeaturecourse.php"><input class="btn-primary" type="button" name="AddSlider" value="ADD SLIDER"></a>
    </td>
    </tr>
     </tbody>         
    </table>
