...
<body>
    ...
    <br>
    <br>
    <h1><b>Footer USEFUL LINKS Are</b></h1>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <?php echo "<a href='deletefooterusefullinks.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='DELETE'></a>";?>
            </td>
        </tr>
    <?php
     }
    ...
    <tr>
    <td colspan=6>
    <a style="margin-left:50%; padding:10px;" href="addfooterusefullinks.php"><input class="btn btn-primary" type="button" name="AddFooter" value="ADD Footer Useful"></a>
    </td> 
    </tr>
     </tbody>         
    </table>
