...
<body>
	...
	<form method="post" enctype="multipart/form-data">
		<table class="table table-responsive table-bordered table-striped" >
			<tr>
				<td>Enter Link name :</td>
				<td><input style="width:60%" type="text" name="bannername"></td>
			</tr>
			<tr>
				<td>Enter Link  :</td>
				<td><input style="width:60%" type="text" name="link"></td>
			</tr>
			
			
			<tr>
			<td colspan=2 ><input style="margin-left:40%;" type="submit" class="btn-primary" name="sub" value="ADD">&nbsp &nbsp &nbsp &nbsp<a href="footerusefullinks.php"><input  type="button" name="sub" class="btn-danger" value="EXIT"></a></td>
			</tr>
...
//	{
		//echo "sucess";
//	}
	$select = "INSERT INTO `usefulfooterlinks`( `name`, `link`) VALUES ('$username','$titlename')";
