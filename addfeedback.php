...
<body>
	...
	<form method="post" enctype="multipart/form-data">
		<table class="table table-responsive table-bordered table-striped" >
			...
			<tr>
			<td colspan=2 ><input style="margin-left:40%;" type="submit" class="btn-primary" name="sub" value="ADD">&nbsp &nbsp &nbsp &nbsp<a href="adminaboutfeedback.php"><input  type="button" name="sub" class="btn-danger" value="EXIT"></a></td>
			</tr>
...
if(isset($_POST['sub']))
{
	...
	$select = "INSERT INTO `aboutfeedback`( `name`, `image`, `givenby`, `content`) VALUES ('$username','$filename','$titlename','$description')";
	$rows = @mysqli_query($link,$select) or die("query not executed");
	if($rows>0)
	{
        //header("location:adminaboutfeedback.php");
