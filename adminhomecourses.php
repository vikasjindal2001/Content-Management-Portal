...
<body>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <?php echo "<a href='deletehomecourses.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='DELETE'></a><br><br><a href='updatehomecourses.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='UPDATE'></a>";?>
            </td>
        </tr>
    <?php
     }
    ...
    <tr>
    <td colspan=6>
    <a style="margin-left:50%; padding:10px;" href="addhomecourses.php"><input class="btn btn-primary" type="button" name="AddCourse" value="ADD Course"></a>
    </td>
    </tr>
     </tbody>         
    </table>
