...
<html>
<head>
	<title>Update Feature Course</title>
	<meta charset="utf-8">
...
<body>
    ...
    include('config.php');
    $execute = "SELECT * FROM `specialcourse` WHERE id=".$id;
	...
	<h1><b>UPDATE Feature Course</b></h1>
	<div class="container">
	<form method="post"  enctype="multipart/form-data">
		<table class="table table-responsive table-bordered table-striped" >
			...
			<tr>
			<td colspan=2 ><input style="margin-left:40%;" type="submit" class="btn-primary" name="sub" value="UPDATE">&nbsp &nbsp &nbsp &nbsp<a href="adminfeaturecourse.php"><input  type="button" class="btn-danger" value="EXIT"></a></td>
			</tr>
...
if(isset($_POST['sub']))
{
    ...
    $select = "update specialcourse set name='$username' , image='$filename' , description='$description' where id=".$id;
