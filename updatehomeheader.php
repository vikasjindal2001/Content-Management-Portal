...
<html>
<head>
	<title>Update Home Header</title>
	<meta charset="utf-8">
...
<body>
    ...
    include('config.php');
    $execute = "SELECT * FROM `header` WHERE $id";
	...
	<form method="post"  enctype="multipart/form-data">
		<table class="table table-responsive table-bordered table-striped" >
			...
			<tr>
			<td colspan=2 ><input style="margin-left:40%;" type="submit" class="btn-primary" name="sub" value="UPDATE">&nbsp &nbsp &nbsp &nbsp<a href="adminmainheader.php"><input  type="button" class="btn-danger" value="EXIT"></a></td>
			</tr>
...
if(isset($_POST['sub']))
{
    ...
    $select = "update header set name='$username' , image='$filename' , contact='$description' where id=".$id;
