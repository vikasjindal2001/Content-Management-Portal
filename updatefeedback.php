...
<body>
    ...
    include('config.php');
    $execute = "SELECT * FROM `aboutfeedback` WHERE id=".$id;
	...
	<form method="post"  enctype="multipart/form-data">
		<table class="table table-responsive table-bordered table-striped" >
            ...
            <tr>
				<td> Given by</td>
				<td><textarea name="title" rows="3" cols="70"><?php echo $column[2]; ?></textarea></td>
			</tr>
			<tr>
				<td> Feedback</td>
			...
			<tr>
			<td colspan=2 ><input style="margin-left:40%;" type="submit" class="btn-primary" name="sub" value="UPDATE">&nbsp &nbsp &nbsp &nbsp<a href="adminaboutfeedback.php"><input  type="button" class="btn-danger" value="EXIT"></a></td>
			</tr>
...
if(isset($_POST['sub']))
{
	...
	if(move_uploaded_file($filetemp,$des))
	{
     ...
     $title = $_POST['title'];
    $select = "update aboutfeedback set name='$username' , image='$filename' , givenby='$title' , content='$description' where id=".$id;
	$rome = @mysqli_query($link,$select) or die("query not executed");
