...
<body>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <?php  echo "<img src='Photo/$column[1]' width='100px' height='50px' alt ='img not available'>";?>
            </td>
            <td>
            <?php echo "<a href='updatefooterimgcont.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='UPDATE'></a>";?>
            </td>
        </tr>
    <?php
     }
