...
<body>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <?php  echo "<img src='Photo/$column[2]' width='100px' height='50px' alt ='img not available'>";?>
            </td>
            <td>
                <?php echo $column[3];?>
            </td>
            <td>
            <?php echo "<a href='updatecoursefeatureslider.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='UPDATE'></a>";?>
            </td>
        </tr>
    <?php
     }
