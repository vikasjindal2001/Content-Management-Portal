...
<body>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <?php echo "<a href='deletestudentregister.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='DELETE'></a>";?>
            </td>
        </tr>
    <?php
     }
    ...
    <tr>
    <td colspan=6>
    <a style="margin-left:50%; padding:10px;" href="addstudentregister.php"><input class="btn btn-primary" type="button" name="AddFooter" value="ADD Footer Useful"></a>
    </td> 
    </tr>
     </tbody>         
    </table>
