...
<body>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <?php echo "<a href='updateadmin.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='UPDATE'></a>";?>
            </td>
        </tr>
    <?php
     }
