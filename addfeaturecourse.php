...
<html>
<head>
	<title>Add Feature Courses</title>
	<meta charset="utf-8">
	...
	<form method="post" enctype="multipart/form-data">
		<table class="table table-responsive table-bordered table-striped" >
			...
			<tr>
				...
				<td><textarea name="content" rows="3" cols="70"></textarea></td>
			</tr>
			<tr>
			<td colspan=2 ><input style="margin-left:40%;" type="submit" class="btn-primary" name="sub" value="ADD">&nbsp &nbsp &nbsp &nbsp<a href="adminfeaturecourse.php"><input  type="button" name="sub" class="btn-danger" value="EXIT"></a></td>
			</tr>
...
if(isset($_POST['sub']))
{
	...
	$select = "INSERT INTO specialcourse(description,image,name) VALUES ('$content','$filename','$username')";
	$rows = @mysqli_query($link,$select) or die("query not executed !!!!!");
	if($rows)
	{
        //header("location:adminfeaturecourse.php?Insertedsucessfully");
