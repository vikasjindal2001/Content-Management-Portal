...
<body>
    ...
    <center>
    <br><br><br>
    <h1><b>Course Welcome Details</b></h1>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <?php echo "<img src='Photo/$column[2]' width='100px' height='50px'";?>
            </td>
            <td>
            <?php echo "<a href='updatecoursewelcome.php?des=$column[3]'><input type='button' class='btn btn-primary' name='btn' value='UPDATE'></a>";?>
            </td>
        </tr>
    <?php
     }
