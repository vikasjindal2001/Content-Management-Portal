...
include('config.php');
$execute = "SELECT * FROM `homeslider`";
...
<body>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <?php echo "<a href='deleteslider.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='DELETE'></a><br><br><a href='updateslider.php?ID=$column[0]'><input type='button' class='btn btn-primary' name='btn' value='UPDATE'></a>";?>
            </td>
        </tr>
    <?php
     }
    ...
    <tr>
    <td colspan=6>
    <a style="margin-left:50%; padding:10px;" href="addslider.php"><input class="btn-primary" type="button" name="AddSlider" value="ADD SLIDER"></a>
    </td>
    </tr>
     </tbody>         
    </table>
