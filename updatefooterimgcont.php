...
<html>
<head>
	<title>Update FOOTER IMAGE CONTENT</title>
	<meta charset="utf-8">
...
<body>
    ...
    include('config.php');
    $execute = "SELECT * FROM `footerimgcont` WHERE id=".$id;
	...
	<h1><b>UPDATE FOOTER IMAGE CONTENT</b></h1>
	<div class="container">
	<form method="post"  enctype="multipart/form-data">
		<table class="table table-responsive table-bordered table-striped" >
        <tr>
				<td> Content</td>
				<td><textarea name="username" rows="3" cols="70"  ><?php echo $column[2]; ?></textarea></td>
			</tr>
			<tr>
			<td> Image</td>
			...
			<tr>
			<td colspan=2 ><input style="margin-left:40%;" type="submit" class="btn-primary" name="sub" value="UPDATE">&nbsp &nbsp &nbsp &nbsp<a href="adminimgcont.php"><input  type="button" class="btn-danger" value="EXIT"></a></td>
			</tr>
...
if(isset($_POST['sub']))
{
    ...
    $select = "update footerimgcont set content='$username' , image='$filename' where id=".$id;
