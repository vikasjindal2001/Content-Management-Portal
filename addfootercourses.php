...
<body>
	...
	<form method="post" enctype="multipart/form-data">
		<table class="table table-responsive table-bordered table-striped" >
			...
			<tr>
			<td colspan=2 ><input style="margin-left:40%;" type="submit" class="btn-primary" name="sub" value="ADD">&nbsp &nbsp &nbsp &nbsp<a href="footercourses.php"><input  type="button" name="sub" class="btn-danger" value="EXIT"></a></td>
			</tr>
...
//	{
		//echo "sucess";
//	}
	$select = "INSERT INTO `footercourses`( `name`, `link`) VALUES ('$username','$titlename')";
