...
<html>
<head>
	<title>Update Home Welcome</title>
	<meta charset="utf-8">
...
<body>
	...
	<form method="post"  enctype="multipart/form-data">
		<table class="table table-responsive table-bordered table-striped" >
			...
			<tr>
			<td colspan=2 ><input style="margin-left:40%;" type="submit" class="btn-primary" name="sub" value="UPDATE">&nbsp &nbsp &nbsp &nbsp<a href="adminhomewelcome.php"><input  type="button" class="btn-danger" value="EXIT"></a></td>
			</tr>
...
if(isset($_POST['sub']))
{
    ...
    $select = "update homewelcome set title='$username' , content='$description' , image='$filename' where id=1";
